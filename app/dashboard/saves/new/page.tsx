...
export default function NewSavePage() {
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white">Create New Save</h1>
        <p className="text-zinc-500 text-sm mt-1">Set up your FM save details.</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Basic Info */}
        <div className="rounded-xl card-panel border border-white/[0.06] p-5 space-y-4">
          <h2 className="font-semibold text-white">Save Details</h2>

          <div>
            <label className="block text-sm font-medium text-zinc-300 mb-1">Save name <span className="text-red-500">*</span></label>
            <input
              type="text"
              required
              value={form.name}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-zinc-300 mb-1">FM Version <span className="text-red-500">*</span></label>
              <select
            ...
            <div>
              <label className="block text-sm font-medium text-zinc-300 mb-1">Manager name</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-zinc-300 mb-1">Starting club <span className="text-red-500">*</span></label>
              <input
                type="text"
                required
        ...
        {/* Save Philosophy */}
        <div className="rounded-xl card-panel border border-white/[0.06] p-5 space-y-4">
          <h2 className="font-semibold text-white">Save Philosophy <span className="text-xs font-normal text-zinc-600">(optional — helps with recommendations)</span></h2>

          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-zinc-300 mb-1">Preferred formation</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-zinc-300 mb-1">Recruitment style</label>
              <select
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-zinc-300 mb-1">Max normal wage (£/week)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-medium text-zinc-300 mb-1">Max key player wage (£/week)</label>
              <input
                type="number"
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-300 mb-1">Long-term goal</label>
            <input
              type="text"
