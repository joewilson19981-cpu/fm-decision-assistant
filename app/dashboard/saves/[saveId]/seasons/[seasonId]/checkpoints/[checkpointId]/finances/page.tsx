  ...
  return (
    <div className="max-w-xl">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-white">Finance Snapshot</h1>
        <p className="text-zinc-500 text-sm mt-1">Record your club's financial position at this checkpoint.</p>
      </div>
