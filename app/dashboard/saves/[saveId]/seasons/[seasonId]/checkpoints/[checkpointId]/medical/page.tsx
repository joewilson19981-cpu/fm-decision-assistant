  ...
  return (
    <div className="max-w-xl">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-white">Medical Snapshot</h1>
        <p className="text-zinc-500 text-sm mt-1">Record your squad's health status.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="rounded-xl card-panel border border-white/[0.06] p-5 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-zinc-300 mb-1">Total injuries this season</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-medium text-zinc-300 mb-1">Current injuries</label>
              <input
                type="number"
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-300 mb-1">Overall squad condition</label>
            <select
