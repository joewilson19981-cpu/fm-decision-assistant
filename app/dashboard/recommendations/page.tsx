  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Decision support across your saves</p>
      </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs text-gray-400">{rec.save.name}{rec.season && ` · ${rec.season.seasonLabel}`}</span>
                  </div>
                ...
                <span className={`text-xs px-2 py-0.5 rounded-full ml-4 ${
                  ...
                  rec.status === 'dismissed' ? 'bg-gray-100 text-gray-400' :
